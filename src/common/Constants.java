...
public final class Constants {
    ...
    public static final String FILE_NAME_PATTERN = "test(\\d+)\\.json";
    ...
    public static final String ANNUAL_CHANGES_LIST = "annualChanges";
    ...
    public static final String GIFTS_PREFERENCES_LIST = "giftsPreferences";
    public static final String PRODUCT_NAME = "productName";
    public static final String PRICE = "price";
    public static final String CATEGORY = "category";
    public static final String NEW_SANTA_BUDGET = "newSantaBudget";
    public static final String NEW_SANTA_GIFTS_LIST = "newGifts";
    public static final String NEW_CHILDREN = "newChildren";
    public static final String CHILDREN_UPDATES_LIST = "childrenUpdates";
